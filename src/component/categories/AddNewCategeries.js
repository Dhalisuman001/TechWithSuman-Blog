...
import { addCategoryAction } from "../../redux/slices/category/CategorySlice";
...
const AddNewCategory = () => {
  ...
  const { appError, loading, serverErr, isCreated } = store;
  //redirect

  if (isCreated) return <Navigate to="/fetch-category" />;
  return (
