...
import poster from "../../asset/logo.png";
const Home = () => {
  return (
    <section className="pb-10 bg-gray-800 h-screen">
      <div className="relative container px-4 pt-2  mx-auto">
        <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
          <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            ...
            <h2 className="max-w-2xl mt-12 mb-12 text-6xl 2xl:text-8xl text-white font-bold font-heading">
              Write down your ideas about tech{" "}
          ...
          <div className="w-full lg:w-1/2 px-4">
            <img className="w-full" src={poster} alt="banner" />
          </div>
        </div>
      </div>
    </section>
