...
const UpdatePassword = () => {
 ...
 const {isPassword,serverErr,appErr,loading} = data;

 if (isPassword)  return <Navigate to={-1}/>
  ...
  return ( 
    <div className="min-h-screen bg-gray-700  flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {serverErr || appErr ? <h3 className="text-red-500 text-center text-lg pt-2">{serverErr} {appErr}</h3> : null}
      </div>
