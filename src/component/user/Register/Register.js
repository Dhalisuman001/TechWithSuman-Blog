            ...
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-white">
                  Create an account and start writting down your ideas
                </h2>
              </div>
            </div>
              ...
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                <form onSubmit={formik.handleSubmit}>
                  <h3 className="mb-10 text-2xl text-white font-bold font-heading">
                    Register Account-{" "}
                    {appError || serverErr ? (
                      <div className="text-red-400 text-[20px]">
                        {serverErr} &nbsp;
                        {appError}
                      </div>
                    ) : null}
